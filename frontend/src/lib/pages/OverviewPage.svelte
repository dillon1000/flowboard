...
{#if createTaskOpen}
  <div class="dialog-layer" role="dialog" aria-modal="true" aria-labelledby="new-assignment-title" tabindex="-1" onkeydown={(event) => event.key === 'Escape' && (createTaskOpen = false)} onclick={(event) => event.target === event.currentTarget && (createTaskOpen = false)}>
    <form class="dialog wide" onsubmit={createAssignment}>
      ...
      <div class="dialog-body">
        ...
        <div class="form-grid">
          <div class="field wide"><label for="assignment-title">Title</label><input class="input" id="assignment-title" name="title" maxlength="120" required /></div>
