...
<div class="not-found-page">
  ...
  <main class="not-found-main">
    <section class="not-found-copy" aria-labelledby="error-title">
      ...
      <h1 id="error-title">{isNotFound ? 'This page is not in your study plan.' : 'This page did not load.'}</h1>
    ...
    <div class="not-found-board" aria-hidden="true">
      <section class="not-found-column">
        ...
        <div class="not-found-task"><strong>Read chapter seven</strong><span></span></div>
        <div class="not-found-task short"><strong>Review lecture notes</strong><span></span></div>
      </section>
      <section class="not-found-column">
        <div class="not-found-column-title"><span></span>In progress</div>
        <div class="not-found-task missing"><b>?</b><strong>Missing assignment</strong></div>
      </section>
      <section class="not-found-column">
        <div class="not-found-column-title"><span></span>Done</div>
        <div class="not-found-task complete"><strong>Submit lab report</strong><span></span></div>
      </section>
    </div>
  </main>
</div>
